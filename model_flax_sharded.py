...
def get_params_spec():
    """Define parameter sharding specifications."""
    return {
        "model": {
            "embed_tokens": {"embedding": P("mp", None)},
            "layers": {
                "self_attn": {
                    "q_proj": {"kernel": P("mp", None)},
                    "k_proj": {"kernel": P("mp", None)},
                    "v_proj": {"kernel": P("mp", None)},
                    "o_proj": {"kernel": P(None, "mp")},
                },
                "mlp": {
                    "gate_proj": {"kernel": P("mp", None)},
                    "up_proj": {"kernel": P("mp", None)},
                    "down_proj": {"kernel": P(None, "mp")},
                },
            },
        },
